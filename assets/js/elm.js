...
var _user$project$Routes$AboutRoute = {ctor: 'AboutRoute'};
var _user$project$Routes$HomeRoute = {ctor: 'HomeRoute'};
var _user$project$Routes$matcherHome = A2(_sporto$hop$Hop_Matchers$match1, _user$project$Routes$HomeRoute, '');
var _user$project$Routes$matchers = _elm_lang$core$Native_List.fromArray(
	[
		A2(_sporto$hop$Hop_Matchers$match1, _user$project$Routes$HomeRoute, ''),
		A2(_sporto$hop$Hop_Matchers$match1, _user$project$Routes$AboutRoute, '/about')
	]);
var _user$project$Routes$config = {basePath: '', hash: false, matchers: _user$project$Routes$matchers, notFound: _user$project$Routes$NotFoundRoute};
var _user$project$Routes$urlParser = _elm_lang$navigation$Navigation$makeParser(
	function (_p0) {
		return A2(
			_sporto$hop$Hop$matchUrl,
			_user$project$Routes$config,
			function (_) {
				return _.href;
			}(_p0));
	});
var _user$project$Routes$reverse = function (route) {
	var _p1 = route;
	switch (_p1.ctor) {
		case 'HomeRoute':
			return A2(
...
var _user$project$Messages$ShowNotFound = {ctor: 'ShowNotFound'};
var _user$project$Messages$ShowAbout = {ctor: 'ShowAbout'};
var _user$project$Messages$ShowHome = {ctor: 'ShowHome'};

var _user$project$Models$init = function (_p0) {
	var _p1 = _p0;
	return {
		ctor: '_Tuple2',
		_0: {route: _p1._0, location: _p1._1},
...
var _user$project$Update$stateUpdate = F2(
	function (msg, model) {
		var _p0 = A2(_elm_lang$core$Debug$log, 'msg', msg);
		switch (_p0.ctor) {
			case 'ShowNotFound':
				var path = _user$project$Routes$reverse(_user$project$Routes$NotFoundRoute);
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _elm_lang$navigation$Navigation$newUrl(
						A2(_sporto$hop$Hop$makeUrl, _user$project$Routes$config, path))
				};
			case 'ShowHome':
				var path = _user$project$Routes$reverse(_user$project$Routes$HomeRoute);
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _elm_lang$navigation$Navigation$newUrl(
			...
			default:
				var path = _user$project$Routes$reverse(_user$project$Routes$AboutRoute);
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _elm_lang$navigation$Navigation$newUrl(
...
var _user$project$Update$urlUpdate = F2(
	function (_p1, model) {
		var _p2 = _p1;
		var _p4 = _p2._1;
		var _p3 = A2(_elm_lang$core$Debug$log, 'urlUpdate location', _p4);
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{route: _p2._0, location: _p4}),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});

var _user$project$Views_Nav$view = function (model) {
	return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$html$Html_Events$onClick(_user$project$Messages$ShowHome)
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('OpenAnsible')
									]))
							])),
						A2(
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_Utils.eq(model.route, _user$project$Routes$HomeRoute) ? 'active' : '')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class(
										_elm_lang$core$Native_Utils.eq(model.route, _user$project$Routes$AboutRoute) ? 'active' : '')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										A2(
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$href('javascript:;'),
												_elm_lang$html$Html_Events$onClick(_user$project$Messages$ShowAbout)
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text('热门')
											]))
									])),
								A2(
								_elm_lang$html$Html$li,
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class(
										_elm_lang$core$Native_Utils.eq(model.route, _user$project$Routes$NotFoundRoute) ? 'active' : '')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										A2(
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$href('javascript:;'),
												_elm_lang$html$Html_Events$onClick(_user$project$Messages$ShowNotFound)
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text('分类')
											]))
									])),
								A2(
								_elm_lang$html$Html$li,
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text('NotFound')
											]))
									]))
							])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('navbar-form navbar-right')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
...
var _user$project$Views_Footer$view = function (model) {
	return A2(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('OpenAnsible Web Application')
									]))
							])),
						A2(
						_elm_lang$html$Html$p,
...
var _user$project$Views_About$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('About OpenAnsible Web Application')
									]))
							])),
						A2(
						_elm_lang$html$Html$p,
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Page About')
							])),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
...
var _user$project$Views_Notfound$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$Views_Layout$layout = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Attributes$href('/assets/css/bootstrap.min.css')
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A3(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$rel('stylesheet'),
						_elm_lang$html$Html_Attributes$type$('text/css'),
						_elm_lang$html$Html_Attributes$href('/assets/css/bootstrap-theme.min.css')
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A3(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$rel('stylesheet'),
						_elm_lang$html$Html_Attributes$type$('text/css'),
						_elm_lang$html$Html_Attributes$href('/assets/css/common.css')
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A3(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$rel('stylesheet'),
						_elm_lang$html$Html_Attributes$type$('text/css'),
						_elm_lang$html$Html_Attributes$href('/assets/css/main.css')
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				_user$project$Views_Nav$view(model),
				function () {
				var _p0 = model.route;
				switch (_p0.ctor) {
					case 'HomeRoute':
						return _user$project$Views_Home$view(model);
					case 'AboutRoute':
						return _user$project$Views_About$view(model);
					default:
						return _user$project$Views_Notfound$view(model);
				}
			}(),
				_user$project$Views_Footer$view(model)
			]));
};

var _user$project$Main$model = {
	init: _user$project$Models$init,
	view: _user$project$Views_Layout$layout,
	update: _user$project$Update$stateUpdate,
	subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none),
	urlUpdate: _user$project$Update$urlUpdate
};
var _user$project$Main$main = {
	main: A2(_elm_lang$navigation$Navigation$program, _user$project$Routes$urlParser, _user$project$Main$model)
};
