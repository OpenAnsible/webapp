    ...
    nav [class "navbar navbar-default navbar-fixed-top"] [
        div [class "container"] [
            ...
            ul [class "nav navbar-nav"] [
                li [class (if model.route == HomeRoute then "active" else "")] [ a [href "javascript:;", onClick ShowHome] [text "探索"] ],
                li [class (if model.route == AboutRoute then "active" else "")] [ a [href "javascript:;", onClick ShowAbout] [text "热门"] ],
                li [class (if model.route == NotFoundRoute then "active" else "")] [ a [href "javascript:;", onClick ShowNotFound] [text "分类"] ],
                li [class (if model.route == NotFoundRoute then "active" else "")] [ a [href "javascript:;", onClick ShowNotFound] [text "NotFound"] ]
            ],
